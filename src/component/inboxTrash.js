...
class inboxTrash extends Component {
    ...
    componentDidMount(){
        ...
        fetch('https://test.skenap.ir/api/v1/showMessageTrash', {
            method: 'POST',
            headers: {
                                ...
                                <div className="col-span-12 lg:col-span-3 xxl:col-span-2">
                                    ...
                                    <div className="intro-y box bg-theme-1 p-5 mt-6">
                                        <div className="border-t border-theme-3 mt-6 pt-6 text-white">
                                            ...
                                            <Link to="/karfarma/inboxBookmark" className="flex items-center px-3 py-2 mt-2 rounded-md "> <FeatherIcon
                                                className="w-4 h-4 ml-2" icon="bookmark"/>منتخب</Link>

                                            <Link to="/karfarma/inboxTrash" className="flex items-center px-3 py-2 mt-2 rounded-md bg-theme-22 font-medium"> <FeatherIcon
