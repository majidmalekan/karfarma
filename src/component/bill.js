...
class payed extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://test.skenap.ir/api/v1/payment', {
            method: 'POST',
            headers: {
        ...
        if (this.state.payments === "") {
            ...
            return (
                <>
                    ...
                    <div className="flex smt-3 mr-auto">
                        <button  className="button text-white bullshit-green shadow-md w-24 mr-auto">
                            <Link className="" to={"/karfarma/invoice?user="+localStorage.getItem('user_id')}>
                                پرداخت انبوه
                            </Link>
                        </button>
                    </div>
