...
class project extends Component {
    ...
    componentDidMount() {
        ...
        fetch('https://test.skenap.ir/api/v1/viewProjects', {
            method: 'POST',
            headers: {
                    ...
                    <tr className="bg-gray-200" key={index}>
                        ...
                        <td className="border-b">
                            <div className="flex items-center">
                                <Link to={{
                                    pathname: '/karfarma/singleProject?project_id='+todo.project_id, state: {
                ...
                <div className="intro-y overflow-auto lg:overflow-visible mt-8 sm:mt-0">
                    <table className="table table-report sm:mt-2"
                        ...
                        <tr>
                            ...
                            <th className="whitespace-no-wrap text-gray-700">عنوان پروژه</th>
                            <th className="whitespace-no-wrap text-gray-700">دسته بندی پروژه</th>
