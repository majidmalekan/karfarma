                                ...
                                <div className="intro-y box">
                                    ...
                                    <div className="p-5" id="input">
                                        <div className="flex flex-col sm:flex-col items-center p-5"
                                             style={{justifyContent:"center"}}>
                                            <label>حوزه پروژه</label>
                                            <p className="text-gray-700">(لطفا حوزه پروژه خود را به دقت انتخاب کنید توجه داشته باشید از میان حوزه ها فقط یک حوزه را به صورت همزمان میتوانید انتخاب کنید)</p>
                                        </div>
                                        <div className="preview mt-5" style={{display:'flex',justifyContent:'space-around'}}>
                                            <button className={this.state.digital ? 'button w-75 shadow-md mr-2 mb-2 bg-gray-200 text-center' : 'button w-75 mr-2 shadow-md mb-2 bg-theme-9 text-white text-center' } onClick={this.onClickDigital} style={{width:'20%',height:'150px'}}>
                                                خدمات سئو
                                            </button>
                                            <button className={this.state.article ? 'button w-75 shadow-md mr-2 mb-2 bg-gray-200' : 'button w-75 shadow-md mr-2 mb-2 bg-theme-9 text-white' } onClick={this.onClickArticle} style={{width:'20%',height:'150px'}}>
                                                سفارش محتوای محصول و خدمات فروش آنلاین
                                            </button>
                                            <button className={this.state.guide ? 'button w-75 shadow-md mr-2 mb-2 bg-gray-200' : 'button w-75 shadow-md mr-2 mb-2 bg-theme-9 text-white' } onClick={this.onClickGuide} style={{width:'20%',height:'150px'}}>
                                                سفارش محتوای اختصاصی
                                            </button>
                                        </div>
                                        <div className="preview mt-3 "  style={{display:'flex',justifyContent:'space-around'}}>
                                            <button className={this.state.design ? 'button w-75 shadow-md mr-2 mb-2 bg-gray-200' : 'button w-75 shadow-md mr-2 mb-2 bg-theme-9 text-white' } onClick={this.onClickDesign} style={{width:'20%',height:'150px'}}>
                                                خدمات تعیین استراتژی محتوا و برندینگ
                                            </button>
                                            <button className={this.state.web ? 'button w-75 shadow-md mb-2 mr-2 bg-gray-200' : 'button w-75 shadow-md mr-2 mb-2 bg-theme-9 text-white' } onClick={this.onClickWeb} style={{width:'20%',height:'150px'}}>
