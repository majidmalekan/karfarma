                    ...
                    <ul className="border-t border-theme-24 py-5 hidden">
                        ...
                        <li>
                            <a href="javascript:;" className="menu">
                                ...
                                <div className="menu__title"> Crud <i data-feather="chevron-down"
                                                                      className="menu__sub-icon"></i></div>
                            </a>
                            <ul className="">
                                <li>
                        ...
                        <li>
                            <a href="javascript:;" className="menu">
                                ...
                                <div className="menu__title"> Users <i data-feather="chevron-down"
                                                                       className="menu__sub-icon"></i></div>
                            </a>
                            <ul className="">
                                <li>
                        ...
                        <li>
                            <a href="javascript:;" className="menu">
                                ...
                                <div className="menu__title"> Pages <i data-feather="chevron-down"
                                                                       className="menu__sub-icon"></i></div>
                            </a>
                            <ul className="">
                                <li>
                        ...
                        <li>
                            ...
                            <ul className="menu__sub-open">
                                <li>
                                    <a href="javascript:;" className="menu">
                                        <div className="menu__icon"><i data-feather="activity"></i></div>
                                        <div className="menu__title"> Grid <i data-feather="chevron-down"
                                                                              className="menu__sub-icon"></i></div>
                                    </a>
                                    <ul className="">
                                        <li>
                                ...
                                <li>
                                    <a href="side-menu-alert.html" className="menu menu--active">
                                        <div className="menu__icon"><i data-feather="activity"></i></div>
                        ...
                        <li>
                            <a href="javascript:;" className="menu">
                                ...
                                <div className="menu__title"> Forms <i data-feather="chevron-down"
                                                                       className="menu__sub-icon"></i></div>
                            </a>
                            <ul className="">
                                <li>
